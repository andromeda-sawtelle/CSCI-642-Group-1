...
\keywords{Compiler, Security, Single-Pass Compiler, C, C++, Use-After-Free, Out-Of-Bounds, Memory Safety, Stack-Smashing, Smaller C, GCC, Clang, LLVM, Pointers, Address Sanitization, Improper Synchronization, Compiler Design, Pointer Tagging, Software Engineering, ACM, GDPR, APRA, NIS2}
